...
def assign_roles(tree,e_hownet,feature_role_dict_10,feature_role_dict_9,feature_role_dict_8,feature_role_dict_7,feature_role_dict_6,feature_role_dict_5,feature_role_dict_4,feature_role_dict_3,feature_role_dict_2,feature_role_dict_1,legal_roles,target_pos,idx,passive,prep_pos,dummy,word2semType_dict,test_trees):
	if tree != None:
	 if tree.children != []:		
		...
		validate_roles2(tree,all_roles,idx,legal_roles,roles_combination)
...
def validate_roles2(tree,all_roles,idx,legal_roles,roles_combination):
	if len(all_roles) > 1:
	  f = 0
	  ch_idx = []
	  for ch in tree.children:

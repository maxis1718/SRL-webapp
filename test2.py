...
def assign_roles(tree,e_hownet,feature_role_dict_10,feature_role_dict_9,feature_role_dict_8,feature_role_dict_7,feature_role_dict_6,feature_role_dict_5,feature_role_dict_4,feature_role_dict_3,feature_role_dict_2,feature_role_dict_1,legal_roles,target_pos,passive,prep_pos,dummy,word2semType_dict):
	if tree != None:
	 if tree.children != []:		
	...
	for ch in tree.children:
		dummy = 0
		assign_roles(ch,e_hownet,feature_role_dict_10,feature_role_dict_9,feature_role_dict_8,feature_role_dict_7,feature_role_dict_6,feature_role_dict_5,feature_role_dict_4,feature_role_dict_3,feature_role_dict_2,feature_role_dict_1,legal_roles,target_pos,passive,prep_pos,dummy,word2semType_dict)
	
	annotated_tree_line = print_tree_line(tree,[])
	print """<html><b>Unannotated:</b><br></html>"""
	#print clean_expr
	print """<html><b><br><br><br>Annotated:<br></b></html>"""
	print ''.join(annotated_tree_line)
	#return tree
...
def read_model():
	...
	legal_roles_file = open("legal_roles.txt")
	features = []
	prob_role = []
...
def srl(e_hownet,feature_role_dict_10,feature_role_dict_9,feature_role_dict_8,feature_role_dict_7,feature_role_dict_6,feature_role_dict_5,feature_role_dict_4,feature_role_dict_3,feature_role_dict_2,feature_role_dict_1,legal_roles,target_pos,prep_pos,word2semType_dict):	
	clean_expr = """document.getElementById('tree').value</html>"""
	tree = parseExpr_unannotated(clean_expr.encode('utf_8'))
	dummy = 0
	passive = isPassive(tree,pp,'False')
	assign_roles(tree,e_hownet,feature_role_dict_10,feature_role_dict_9,feature_role_dict_8,feature_role_dict_7,feature_role_dict_6,feature_role_dict_5,feature_role_dict_4,feature_role_dict_3,feature_role_dict_2,feature_role_dict_1,legal_roles,target_pos,passive,prep_pos,dummy,word2semType_dict)
...
if __name__ == "__main__":
 ...
 try:
	...
	#clean_expr = form.getvalue('tree')
	#self.response.write(clean_expr.encode('utf_8'))
	#tree = parseExpr_unannotated(clean_expr.encode('utf_8'))
	#print_tree(tree)
 ...
 <center><b>
  <h3> Sinica Semantic Role Labeling (SRL) System </h3></b>
    ...
    <div><textarea name="tree" rows="2" cols="120"></textarea></div>
      <div><input type="button" value="label" onclick="srl(e_hownet,feature_role_dict_10,feature_role_dict_9,feature_role_dict_8,feature_role_dict_7,feature_role_dict_6,feature_role_dict_5,feature_role_dict_4,feature_role_dict_3,feature_role_dict_2,feature_role_dict_1,legal_roles,target_pos,prep_pos,word2semType_dict)"<html>></div>
   </form>
	</html>
	"""
